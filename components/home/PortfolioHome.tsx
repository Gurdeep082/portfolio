...
export default function PortfolioHome() {
  ...
  return (
    <div className="portfolio-shell min-h-screen bg-white dark:bg-transparent text-[#123d3d] dark:text-[#E0E0E0] transition-colors duration-500">
      <div className="mx-auto max-w-[1680px] px-3 pb-[30px] pt-3 max-md:px-[9px] max-md:pb-[18px] max-md:pt-[6px] sm:px-[18px] lg:px-6">
        <header
          ref={headerRef}
          className="
    sticky
  ...
  "
                ...
                <div className="border-t border-[#123d3d]/[0.07] dark:border-[#2f2f2f] pt-2">
                  <div className="flex h-[60px] items-center justify-between rounded-xl px-4">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <span className="text-[15px] font-semibold text-[#284b4b] dark:text-[#B0B0B0]">
                        Dark Mode
                      </span>
                    </div>
      ...
      `}
        ...
        <main>
          <section
            id="home"
            className="relative overflow-hidden rounded-[11px] border border-[#123d3d]/10 dark:border-[#2f2f2f] bg-white dark:bg-[#121212] px-3 pb-6 pt-6 shadow-[0_3px_9px_rgba(18,61,61,0.05)] dark:shadow-none max-md:px-3 max-md:pb-[15px] max-md:pt-[15px] sm:px-6 lg:px-[30px]"
          >
            ...
            <div className="relative grid items-center gap-6 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="max-w-xl">
                <p className="mb-3 text-[13.5px] font-medium text-[#2a6f6d] dark:text-[#E0E0E0]">
                  Hi, I&apos;m
                </p>
                <h1 className="text-3xl font-black leading-[0.95] tracking-[-0.045em] text-[#10202d] dark:text-[#ffffff] max-md:text-[2rem] sm:text-[2.25rem] lg:text-[3.075rem]">
                  Gurdeep Singh
                ...
                <p className="mt-[15px] max-w-lg text-[12px] leading-[21px] text-[#4f6e6b] dark:text-[#B0B0B0] max-md:mt-3 max-md:text-[10px] max-md:leading-[18px] sm:text-[13.5px]">
                  I build scalable, high-performance web applications with clean
                  code and great user experiences.
                </p>

                <div className="mt-[21px] flex flex-col gap-[9px] max-md:mt-[15px] sm:flex-row">
                  <a
                    href="#projects"
                    className="inline-flex min-h-[33px] items-center justify-center whitespace-nowrap rounded-[9px] bg-[#2ac7a6] px-[15px] py-[10.5px] text-[10.5px] font-semibold text-white shadow-[0_3px_9px_rgba(42,199,166,0.15)] transition duration-200 hover:-translate-y-0.5 hover:bg-[#23b59f] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#2ac7a6]/40 dark:bg-[#e0e0e0] dark:text-[#121212] dark:shadow-[0_6px_15px_rgb(0_0_0/20%)] dark:hover:bg-[#f2f2f2] dark:active:bg-[#c8c8c8]"
                  >
                    View My Work
                  </a>
                  <a
                    href="#contact"
                    className="inline-flex min-h-[33px] items-center justify-center whitespace-nowrap rounded-[9px] border border-[#2ac7a6]/30 bg-transparent px-[15px] py-[10.5px] text-[10.5px] font-semibold text-[#2ac7a6] transition duration-200 hover:-translate-y-0.5 hover:border-[#2ac7a6]/50 hover:bg-[#f0f8f6] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#2ac7a6]/30 dark:border-[#555555] dark:bg-[#242424] dark:text-[#e0e0e0] dark:hover:border-[#888888] dark:hover:bg-[#2f2f2f] dark:hover:text-white dark:active:bg-[#1c1c1c]"
                  >
                    Contact Me
                  </a>
                </div>
              ...
              <div className="relative mx-auto w-full max-w-[510px]">
                <div className="transition-all duration-300 relative overflow-hidden rounded-[11px] border border-[#123d3d]/10 dark:border-[#2f2f2f] bg-[#f8fbfa] dark:bg-[#1a1a1a] p-[15px] shadow-[0_3px_9px_rgba(18,61,61,0.05)] dark:shadow-[0_16px_45px_rgba(0,0,0,0.4)] backdrop-blur-sm">
                  ...
                  >
                    ...
                    >
                      ...
                      {"\n"}
                      <span className="inline-block                       pl-[9px] sm:pl-3">
                      ...
                      {"\n"}
                      <span className="inline-block                       pl-3 sm:pl-[18px]">
                        <span className="text-[#7c3aed] dark:text-[#C586C0]">
                          return
                        </span>{" "}
                        <span className="text-[#a31515] dark:text-[#CE9178]">
    ...
    "
            ...
            <div className="transition-all duration-300 relative flex flex-col overflow-hidden             rounded-[11px] border border-[#123d3d]/10 dark:border-[#2f2f2f] bg-white dark:bg-[#1a1a1a] p-[18px] text-[#123d3d] dark:text-[#E0E0E0] shadow-[0_6px_18px_rgba(18,61,61,0.05)] dark:shadow-[0_6px_18px_rgba(0,0,0,0.2)] max-md:p-3 sm:p-[21px]">
              ...
              <div
                className="
                    ...
                    dark:[background-image:radial-gradient(circle,rgba(224,224,224,0.35)_2px,transparent_2px)]
              ...
              <div className="relative z-10 flex h-full flex-col">
                ...
                <div className="mb-[21px]">
                  ...
                  <div className="mt-3 h-[2px] w-12 rounded-full bg-[#2ac7a6] dark:bg-[#E0E0E0] dark:bg-[#E0E0E0] dark:bg-[#E0E0E0]" />
                </div>

                {/* Description */}
                <p className="max-w-[465px] text-[12px] font-medium leading-[1.85] text-[#304f5b] dark:text-[#B0B0B0]">
          ...
          id="projects" className="mt-6 max-md:mt-[15px]">
            ...
            {loading ? (
              <div className="transition-all duration-300 rounded-[17px] border border-[#123d3d]/15 dark:border-[#2f2f2f] bg-white dark:bg-[#1a1a1a] p-[18px] text-[#2d5a59] dark:text-[#B0B0B0]">
                Loading projects...
              </div>
            ) : fetchError ? (
              <div className="rounded-[17px] border border-rose-200 dark:border-rose-900/50 bg-rose-50 dark:bg-rose-900/20 p-[18px] text-rose-700 dark:text-rose-300">
                {fetchError}
              </div>
            ) : (
                  ...
                  return (
                    <article
                      ...
                      className="
                        ...
                        border-[#123d3d]/10
                        bg-white
                        shadow-[0_12px_30px_rgba(18,61,61,0.06)]
                        transition-all duration-300
                        hover:-translate-y-1
                        hover:border-[#2ac7a6]/40
                        dark:hover:border-[#555555]
                      ...
                      <div className="flex h-[60%] min-h-0 flex-col overflow-hidden p-[13px] max-md:p-2 sm:p-4">
                        ...
                        <div className="mb-3 max-md:mb-2">
                          <h3
                            ...
                            transition-colors
                            duration-200
                            group-hover:text-[#123d3d]
                            dark:group-hover:text-[#ffffff]
                          "
                          >
                            {project.title}
                          </h3>
          ...
          >
            ...
            <div className="mb-7">
              <div className="flex items-center gap-3">
                <h2 className="text-[18px] font-extrabold tracking-[-0.035em] text-[#10202d] dark:text-[#E0E0E0]">
                  Experience & Education
                </h2>

                <span className="h-[3px] w-8 rounded-full bg-[#2ac7a6] dark:bg-[#E0E0E0] dark:bg-[#E0E0E0] dark:bg-[#E0E0E0]" />
              </div>

              <p className="mt-2 text-sm text-[#6b8583] dark:text-[#B0B0B0]">
    ...
    ====================================== */}
              ...
              <div className="relative pb-9">
                ...
                <span
                  ...
                  bg-[#2ac7a6] dark:bg-[#888888]
                  shadow-[0_0_0_1px_rgba(42,199,166,0.25)] dark:shadow-[0_0_0_1px_rgba(136,136,136,0.25)]
                  sm:-left-[45px]
                "
                />
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    <p className="mb-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#2ac7a6] dark:text-[#E0E0E0]">
                      Experience
                    </p>

                    <h3 className="text-[15px] font-extrabold tracking-[-0.025em] text-[#123d3d] dark:text-[#E0E0E0]">
                      Software Developer Intern
                    </h3>

                    <p className="mt-1 text-sm font-semibold text-[#39716c] dark:text-[#E0E0E0]">
              ...
              <div className="relative pb-9">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[#607977] dark:text-[#B0B0B0]">
    ...
    ====================================== */}
              ...
              <div className="relative">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    <h3 className="text-lg font-extrabold tracking-[-0.02em] text-[#123d3d] dark:text-[#E0E0E0]">
          ...
          >
            {/* Decorative elements */}
            <div className="pointer-events-none absolute -right-[15px] -top-[15px] h-48 w-48 rounded-full bg-[#2ac7a6] dark:bg-[#ffffff]/5 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-[18px] -left-[15px] h-48 w-48 rounded-full bg-[#123d3d]/5 dark:bg-[#ffffff]/3 blur-3xl" />

            <div className="relative grid gap-[18px] max-md:gap-[15px] lg:grid-cols-[0.85fr_1.15fr] lg:gap-9">
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  {/* Heading */}
                  <h3 className="max-w-md text-[1.875rem] font-black leading-[1.05] tracking-[-0.03em] text-[#10202d] dark:text-[#f2f2f2] max-md:text-[1.5rem] sm:text-[2.25rem]">
                    Let&apos;s build
                ...
                {/* Contact details */}
                <div className="mt-6 space-y-2 max-md:mt-[18px]">
                  {/* Phone */}
                  <a
                  ...
                  "
                  >
                    <span className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-[9px] bg-[#edf7f5] dark:bg-[#242424] text-[#123d3d] dark:text-[#d0d0d0]">
                      <svg
                        width="18"
                        height="18"
                        viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    >
                      ...
                      <path d="M8.5 7.5c.25-.3.65-.35.98-.18l1.05.53c.3.15.44.5.34.82l-.4 1.2c-.08.25-.04.52.12.73a7.7 7.7 0 0 0 2.8 2.8c.21.16.48.2.73.12l1.2-.4c.32-.1.67.04.82.34l.53 1.05c.17.33.12.73-.18.98l-.5.42c-.43.36-1.02.48-1.55.3a10.8 10.8 0 0 1-6.76-6.76c-.18-.53-.06-1.12.3-1.55l.42-.5Z" />
                    </svg>
                    </span>
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <h4 className="mt-2 text-xl font-extrabold tracking-[-0.025em] text-[#10202d] dark:text-[#e6e6e6]">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <label className="block">
                    <span className="text-xs font-bold text-[#284b4b] dark:text-[#d4d4d4]">
                      Full name
                    </span>
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    className="group
                      ...
                      dark:shadow-[0_10px_24px_rgba(0,0,0,0.45)]
                      transition-all
                      duration-200
                      hover:-translate-y-0.5
                      hover:bg-[#23b59f]
                  ...
                  <div
                    ...
                    className={
                      contactStatus === "success"
                        ? "mt-4 rounded-xl border border-[#2ac7a6]/30 bg-[#edf9f6] px-4 py-3 dark:border-[#2ac7a6]/40 dark:bg-[#12352f]"
                        : "mt-4 rounded-xl border border-[#e05252]/30 bg-[#fdf0ef] px-4 py-3 dark:border-[#e07a7a]/40 dark:bg-[#3a1f1f]"
                    }
                  >
                    <p
                      className={
                    ...
                    >
                      {contactStatus === "success"
                        ...
                        : contactStatus === "incomplete"
                          ...
                          : "Unable to send your message right now. Please email or WhatsApp me directly instead."}
                    </p>
                  </div>
                ) : null}
              </form>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="mt-3 max-w-xs text-sm leading-7 text-[#2d5a59] dark:text-[#B0B0B0]">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#003f33] dark:text-[#E0E0E0]">
                Quick Links
              </h4>

              <ul className="space-y-2 text-sm text-[#2d5a59] dark:text-[#B0B0B0]">
                <li>
                  <a href="#home" className="transition hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]">
                    Home
                  </a>
                </li>

                <li>
                  <a href="#about" className="transition hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]">
                    About
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="#projects"
                    className="transition hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]"
                  >
                    Projects
                  </a>
                </li>
          ...
          "
                ...
                <p className="max-w-[180px] text-xs leading-5 text-[#2d5a59] dark:text-[#B0B0B0]">
                  Building digital solutions that make a difference.
                </p>
              </div>
            ...
            <div className="border-t border-[#003f33]/10 dark:border-[#2f2f2f]">
              ...
              <div className="border-b border-[#003f33]/10 dark:border-[#2f2f2f]">
                ...
                >
                  <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#003f33] dark:text-[#E0E0E0]">
                    Quick Links
                  </span>

                  <span
                    className={`
              text-lg text-[#2ac7a6] dark:text-[#E0E0E0]
              transition-transform duration-300
          ...
          `}
                >
                  <ul className="space-y-3 pl-1 text-sm text-[#2d5a59] dark:text-[#B0B0B0]">
                    <li>
                      <a href="#home" className="hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]">
                        Home
                      </a>
                    </li>

                    <li>
                      <a href="#about" className="hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]">
                        About
                      </a>
                    </li>

                    <li>
                      <a href="#projects" className="hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]">
                        Projects
                      </a>
                    </li>

                    <li>
                      <a href="#contact" className="hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]">
                        Contact
                      </a>
                    </li>
                  </ul>
                  ...
                  <ul className="space-y-3 pl-1 text-sm text-[#2d5a59] dark:text-[#B0B0B0]">
                    <li>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="hover:text-[#2ac7a6] dark:hover:text-[#E0E0E0]"
                      >
                        GitHub
                      </a>
                    </li>
    ...
    "
          >
            ...
            <p>
              Built with <span className="text-[#2ac7a6] dark:text-[#E0E0E0]">❤</span> and lots of
              ☕
            </p>
          </div>
        </footer>
